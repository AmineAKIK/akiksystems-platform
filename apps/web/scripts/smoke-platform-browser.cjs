    ...
    const targets = [
      {
        ...
        summary: 'STUDI training currently in progress, providing the formal learning context for full-stack web and mobile development.',
        metadata: 'Dates not specified · In progress',
        body: 'This STUDI training prepares the Professional Title RNCP 37674.',
        alternateLocale: 'fr',
      ...
      },
      {
        ...
        summary: 'Formation STUDI actuellement en cours, donnant le contexte d’apprentissage formel du développement web et web mobile.',
        metadata: 'Dates non renseignées · En cours',
        body: 'Cette formation STUDI prépare au titre professionnel RNCP 37674.',
        alternateLocale: 'en',
