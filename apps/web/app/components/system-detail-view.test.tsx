...
describe('SystemDetailView', () => {
  it('renders the v1 presentation vocabulary as semantic HTML in source order', () => {
    ...
    expect(html).toContain(
      '<img alt="Sentinel dashboard" decoding="async" loading="lazy" src="/private-preview/image"/>',
    );
