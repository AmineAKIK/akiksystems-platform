...
export async function action({ request }: Route.ActionArgs) {
  ...
  const lastSystem = await db
    ...
    .executeTakeFirst();
  const editorialPosition = (lastSystem?.editorial_position ?? -1) + 1;
        ...
        <div className="aks-proof-stack">
          ...
          <section className="aks-admin-card">
            <div className="aks-proof-stack">
              ...
              <Text tone="muted">
                Create an empty System shell, then author EN/FR identity,
                presentation, evidence and media explicitly. No title, slug or
                public copy is prefilled by the application.
              </Text>
              <Form method="post">
