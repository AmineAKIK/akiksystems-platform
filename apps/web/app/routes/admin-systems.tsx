...
import type { Route } from './+types/admin-systems';
...
export default function AdminSystemsRoute() {
        ...
        <div className="aks-proof-stack">
          <section className="aks-admin-card">
            <div className="aks-proof-stack">
              ...
              <Text tone="muted">
                Manage System order, prominence and the dedicated workspace for
                each product. EN/FR publication state remains independent inside
                each System.
              </Text>
              <div className="aks-proof-actions">
                <Link href="/admin">Back to administration</Link>
                <Link href="/en/systems">Public Systems</Link>
              </div>
            </div>
          </section>
